...
- Use mdast-util-find-and-replace for @path transformations
- Two-plugin approach for GSD tags: remark normalization + rehype styling
- Cytoscape.js for dependency graph visualization
- CSS Grid for Kanban with three columns
- GSD section at top of navigation

**Issues Resolved:**
- Package path resolution when running via npx
- Unknown code block languages (svg, mermaid) causing Shiki crashes
