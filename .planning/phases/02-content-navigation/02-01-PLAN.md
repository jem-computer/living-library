...
<task type="auto">
  ...
  <action>
    ...
    Reference research Pattern 1 for exact syntax.
  </action>
  <verify>
...
<task type="auto">
  ...
  <verify>
    Import and call buildNavTree with mock entries in Node REPL.
    Verify output is nested tree structure.
  </verify>
  <done>
